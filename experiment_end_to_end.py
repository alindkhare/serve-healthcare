...
filename = "solve_random_profile_results.jsonl"
file_path = Path(filename)
model_list = solve_random()
#print(model_list)
lat = profiler.profile_ensemble(model_list, file_path, fire_clients=False, with_data_collector=True)
print("lat95: {}".format(lat))
